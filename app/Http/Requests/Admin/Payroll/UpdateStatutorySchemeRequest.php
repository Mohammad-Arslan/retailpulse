...
final class UpdateStatutorySchemeRequest extends FormRequest
{
    ...
    {
        $schemeId = $this->route('statutory_scheme')?->id ?? $this->route('statutory_scheme');

        return [
            'code' => ['required', 'string', 'max:64', Rule::unique('statutory_schemes', 'code')->ignore($schemeId)],
