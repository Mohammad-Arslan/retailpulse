    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Admin/Leave/Types/Index', [
            'types' => $types->through(fn (LeaveType $type) => [
                ...
                'allow_leave_claim' => $type->allow_leave_claim,
                'allow_cash_claim' => $type->allow_cash_claim,
                'payroll_toil_payout_component_code' => $type->payroll_toil_payout_component_code,
                'status' => $type->status,
            ]),
            'filters' => $filters,
        ]);
