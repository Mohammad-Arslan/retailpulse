...
final class AdminNavigationCatalog
{
    public static function register(NavigationRegistry $registry): void
    {
        ...
        $registry->registerSection(new NavigationSection('hr', 'hrSection', 55, [
            ...
            self::item('departments', 'departments', 'admin.hr.departments.index', 'building-2', 'hr', 11, [
                'permission' => 'hr.manage-org',
                'permissionsAny' => ['hr.manage-org', 'hr.view-employees'],
                'module' => 'hr',
                'routePattern' => 'admin.hr.departments.*',
                'keywords' => ['departments', 'org', 'organization'],
            ]),
            self::item('designations', 'designations', 'admin.hr.designations.index', 'briefcase', 'hr', 12, [
                'permission' => 'hr.manage-org',
                'permissionsAny' => ['hr.manage-org', 'hr.view-employees'],
                'module' => 'hr',
                'routePattern' => 'admin.hr.designations.*',
                'keywords' => ['designations', 'job title', 'roles'],
            ]),
            self::item('grades', 'grades', 'admin.hr.grades.index', 'layers', 'hr', 13, [
                'permission' => 'hr.manage-org',
                'permissionsAny' => ['hr.manage-org', 'hr.view-employees'],
                'module' => 'hr',
            ...
            self::item('holidayCalendars', 'holidayCalendars', 'admin.hr.holiday-calendars.index', 'calendar-days', 'holiday_calendar', 19, [
                ...
                'routePattern' => 'admin.hr.holiday-calendars.*',
                'keywords' => ['holiday', 'calendar', 'public holiday'],
            ]),
            ...
            self::item('toil-claims', 'toilClaims', 'admin.overtime.toil-claims.index', 'coins', 'overtime', 88, [
                ...
                'module' => 'overtime',
                'routePattern' => 'admin.overtime.toil-claims.*',
                'keywords' => ['toil', 'time off in lieu', 'comp off', 'cash claim'],
            ]),
