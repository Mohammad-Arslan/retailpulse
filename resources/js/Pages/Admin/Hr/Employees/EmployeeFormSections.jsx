    ...
    if (section === 'basic') {
        return (
            <div className="grid gap-4 sm:grid-cols-2">
                {(nextCode || employee?.employee_code) && (
                    <AutoGeneratedCodeField
                        label={t('pages.hrEmployees.fields.code')}
                        value={employee?.employee_code || nextCode}
                        hint={
                            employee?.employee_code
                                ? undefined
                                : t('pages.hrEmployees.fields.codeAutoHint')
                        }
                    />
                )}
            ...
            <div className="space-y-3">
                ...
                {(data.dependents ?? []).map((row, index) => (
                    <div key={row.id ?? index} className="grid gap-3 rounded-lg border border-rp-border p-3 sm:grid-cols-2">
                        ...
                        <AdminFormField label={t('pages.hrEmployees.fields.gender')}>
                            <Select
                                value={row.gender ?? ''}
                                isDisabled={readOnly}
                                options={[
                                ...
                                onChange={(v) => {
                                    const next = [...data.dependents];
                                    next[index] = { ...next[index], gender: v ?? '' };
                                    setData('dependents', next);
                                }}
                            />
                        </AdminFormField>
                        <AdminFormField label={t('pages.hrEmployees.fields.nationalId')}>
                            <input
                                className="rp-form-input"
