...
function Index({ calendars, filters, legalEntities = [], branches = [], nextCode = '' }) {
    const can = useCan();
    const { t } = useTranslation();
    const { trackJob } = useImportJobsTray();
    const [modalOpen, setModalOpen] = useState(false);
    const form = useForm(emptyForm(nextCode));
    ...
    const openCreate = () => {
        form.clearErrors();
        form.setData(emptyForm(nextCode));
        setModalOpen(true);
    };
                ...
                <form onSubmit={submit} className="space-y-4 p-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        <AutoGeneratedCodeField
                            ...
                            hint={t('pages.holidayCalendars.fields.codeAutoHint')}
                        />
