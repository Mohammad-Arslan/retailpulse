...
const AlertDialogOverlay = React.forwardRef(function AlertDialogOverlay(
    ...
    return (
        <AlertDialogPrimitive.Overlay
            ...
            className={cn(
                'fixed inset-0 z-50 bg-ink-900/60 backdrop-blur-sm data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0',
                className,
            )}
            {...props}
        />
    ...
    return (
        <AlertDialogPortal>
            ...
            <AlertDialogPrimitive.Content
                ...
                className={cn(
                    'fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-2xl border border-rp-border bg-rp-surface p-6 shadow-2xl duration-200 sm:max-w-lg',
...
const AlertDialogTitle = React.forwardRef(function AlertDialogTitle(
    ...
    return (
        <AlertDialogPrimitive.Title
            ...
            className={cn('font-display text-lg font-semibold text-rp-text', className)}
            {...props}
        />
    );
});
...
const AlertDialogDescription = React.forwardRef(function AlertDialogDescription(
    ...
    return (
        <AlertDialogPrimitive.Description
            ...
            className={cn('text-sm text-rp-text-secondary', className)}
            {...props}
        />
    );
});
