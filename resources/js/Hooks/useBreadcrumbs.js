...
const ROUTE_CRUMBS = {
    ...
    'Admin/PurchaseRequests/Index': ['home', 'purchaseRequests'],
    'Admin/PurchaseRequests/Create': ['home', 'purchaseRequests', 'create'],
    'Admin/PurchaseRequests/Show': ['home', 'purchaseRequests', 'view'],
    ...
    'Admin/Leave/Encashments/Index': ['home', 'leaveEncashments'],
    'Admin/Leave/Encashments/Create': ['home', 'leaveEncashments', 'create'],
    'Admin/Leave/YearEndRuns/Index': ['home', 'leaveYearEndRuns'],
    'Admin/Leave/Entitlements/Index': ['home', 'leaveEntitlements'],
    'Admin/Overtime/ToilClaims/Index': ['home', 'toilClaims'],
    'Admin/Overtime/ToilClaims/Create': ['home', 'toilClaims', 'create'],
...
const CRUMB_HREFS = {
    ...
    purchaseRequests: 'admin.purchase-requests.index',
    ...
    leaveEncashments: 'admin.leave.encashments.index',
    leaveYearEndRuns: 'admin.leave.year-end-runs.index',
    leaveEntitlements: 'admin.leave.entitlements.index',
    toilClaims: 'admin.overtime.toil-claims.index',
